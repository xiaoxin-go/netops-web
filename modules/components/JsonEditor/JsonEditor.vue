<template>
  <vue3-ts-json-editor ref="editor"
                       :text="value"
...
import {defineEmits, defineProps, onMounted, PropType, Ref, ref} from "vue";
import Vue3TsJsonEditor, {Content, OnChangeStatus} from 'vue3-ts-jsoneditor';
import {JsonEditorOptions} from "./typing";
...
const change = (content: Content, previousContent: Content, patchResult: OnChangeStatus) => {
  if (patchResult.contentErrors === null) {
    emit("update:value", content.text)
  }
}
